...
def filtrar_carreras(df_carreras):
    ...
    # Aplicar máscaras booleanas (filtros dinámicos) con pandas
    # Usamos .str.casefold() o .str.lower() para evitar problemas con mayúsculas/minúsculas
    condicion_provincia = df_carreras['Provincia'].str.lower() == provincia.lower()
    condicion_tipo = df_carreras['Tipo'].str.lower() == tipo.lower()
    
    # 3. Filtrar el DataFrame original
    df_filtrado = df_carreras[condicion_provincia & condicion_tipo]
    
    # 4. Devolver el DataFrame resultante
    return df_filtrado