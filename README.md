...
- generar_ranking: Evalúa la afinidad de todas las carreras filtradas con el perfil del usuario, elimina disciplinas duplicadas y devuelve el ranking completo ordenado por afinidad.
